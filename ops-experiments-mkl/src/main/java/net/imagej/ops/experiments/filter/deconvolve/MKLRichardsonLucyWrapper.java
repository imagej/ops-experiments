...
/*@Properties(value = {
		...
		@Platform(value = "windows-x86_64", link="libiomp5md", linkpath = {
		...
		@Platform(value = "linux-x86_64", link = { "MKLFFTW"}, linkpath = { "/opt/intel/lib/intel64/",
				"/opt/intel/mkl/lib/intel64/" }, includepath = "/opt/intel/mkl/include/") })*/
@Properties(value = {
